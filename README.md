...
<p align="center">
    <a href="https://github.com/compty001/go-admin/wiki">Documentation</a> | 
...
see the [docs](https://github.com/compty001/go-admin/blob/master/docs/cn/index.md) for detail
...
func main() {
	...
	cfg := config.Config{
    	...
    	// Generators: see https://github.com/compty001/go-admin/blob/master/examples/datamodel/tables.go 
...
More Examples: [https://github.com/compty001/go-admin/tree/master/examples](https://github.com/compty001/go-admin/tree/master/examples)
